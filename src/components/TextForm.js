    ...
    return (
        <>
            <div className='container my-3'>
                ...
                <button disabled={text.length === 0} style={{ backgroundColor: props.mode === `dark` ? `transparent` : `#0B5ED7` }} className="btn btn-primary mx-1 my-1" onClick={handleExtraSpaces}>Remove Extra Spaces</button>
            </div>
